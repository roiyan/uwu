...
export const metadata = {
  ...
  description:
    "Inspirasi undangan digital dari pasangan-pasangan uwu.",
};
  ...
  return (
    <main className="px-6 pb-24 pt-14">
      <div className="mx-auto max-w-6xl">
        <ScrollReveal>
          <div className="text-center">
            ...
            <h1 className="mt-3 font-display text-4xl text-white md:text-5xl">
              Cerita cinta yang{" "}
              <span className="italic text-gradient">kami bantu ceritakan</span>
            </h1>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {SHOWCASES.map((s, idx) => (
            <ScrollReveal key={s.couple} delay={idx * 0.1}>
              <article className="overflow-hidden rounded-2xl border border-[color:var(--dark-border)] bg-[color:var(--color-dark-surface)]">
                <div
                ...
                <div className="space-y-3 p-5">
                  ...
                  <div className="flex items-center justify-between border-t border-[color:var(--dark-border)] pt-3">
                    <span className="text-xs text-[color:var(--color-dark-text-muted)]">
                      Tingkat kehadiran
                    </span>
                    <span
        ...
        <section className="mt-16 overflow-hidden rounded-3xl border border-[color:var(--dark-border-hover)] bg-[color:var(--color-dark-surface)] p-10 text-center">
          <h2 className="font-display text-3xl text-white md:text-4xl">
            Tertarik ditampilkan di sini?
          </h2>
          <p className="mx-auto mt-3 max-w-xl text-sm text-[color:var(--color-dark-text-secondary)]">
          ...
          <Link
            href="/register"
            className="mt-6 inline-block rounded-full bg-gradient-brand px-8 py-3 text-sm font-medium text-white transition-transform hover:scale-105"
          >
            Mulai Undangan Anda
          </Link>
        </section>
